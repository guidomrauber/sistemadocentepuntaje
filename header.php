...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>SISTEMA DE PUNTAJE DOCENTE</title>  
...
<html>
  <head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title>IES9008 MANUEL BELGRANO</title>
...
<div class="wrapper">
  ...
  <header class="top-navbar">
		<nav class="navbar navbar-expand-lg navbar-dark bg-primary"style="background-color: #00aa4e;">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active"><a class="nav-link" href="escritorio.php">INICIO</a></li>
						<li class="nav-item active"><a class="nav-link" href="puntaje.php">PUNTAJE</a></li>
